...
public class BodyBgDetectFragment extends BaseFragment {

    private final static String TAG = BodyBgDetectFragment.class.getSimpleName();
    ...
    private String initModel() {
        ...
        String[] modelPathsDetector = {
                "rvm_mobilenetv3_fp32.tnnmodel",
                "rvm_mobilenetv3_fp32.tnnproto",
        };
        ...
        for (int i = 0; i < modelPathsDetector.length; i++) {
            ...
            FileUtils.copyAsset(getActivity().getAssets(), "rvm_detector/"+modelFilePath, interModelFilePath);
        }
        return targetDir;
    }
